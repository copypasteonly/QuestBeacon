...
function Settings:Initialize()
    ...
    self:CreateLabel(frame, "Available Quest Filters", 230, -260, 13)
    self:CreateCheck(frame, "Show low-level quests", "availability.lowLevel", 230, -285)
    self:CreateCheck(frame, "Show quests above level +3", "availability.highLevel", 230, -320)
    self:CreateCheck(frame, "Show event quests", "availability.event", 230, -355)
    self:CreateLabel(frame, "Quest Mob Icons", 230, -390, 13)
    self:CreateCheck(frame, "Target frame", "questMobs.target", 230, -412)
    self:CreateCheck(frame, "Mouseover tooltip", "questMobs.tooltip", 230, -442)
    self:CreateCheck(frame, "Nameplates", "questMobs.nameplates", 230, -472)
    self:CreateSlider(frame, "Tracker opacity", "trackerOpacity", 0, 100, 430, -260)
    self:CreateButton(frame, "Service markers", 430, -340, 170, function() Settings:ToggleMarkerFrame() end)
    self:CreateButton(frame, "Reset interface", 230, -510, 170, function()
        QuestBeacon.Config:ResetUI()
        Settings:Refresh()
    end)
    self.historyArmed = false
    self.historyButton = self:CreateButton(frame, "Reset quest history", 430, -510, 170, function()
